...
export default function DefinirSenha() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      navigate('/login', { state: { mensagem: 'Senha definida com sucesso! Faça login para acessar o painel.' } })
    } catch {
    ...
    <div className="flex min-h-dvh items-center justify-center bg-zinc-950 px-4 font-sans">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-extrabold text-zinc-100">Defina sua senha</h1>
