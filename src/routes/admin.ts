...
export async function adminRoutes(fastify: FastifyInstance) {
  ...
  fastify.delete('/admin/estabelecimentos/:id', {
    ...
    await prisma.$transaction([
      ...
      prisma.pagamentoItem.deleteMany({ where: { estabelecimentoId: id } }),
      prisma.pagamento.deleteMany({ where: { estabelecimentoId: id } }),
      prisma.itemComandaRateio.deleteMany({ where: { itemComanda: { comanda: { conta: { estabelecimentoId: id } } } } }),
      prisma.itemComanda.deleteMany({ where: { comanda: { conta: { estabelecimentoId: id } } } }),
      prisma.comanda.deleteMany({ where: { conta: { estabelecimentoId: id } } }),
      prisma.conta.deleteMany({ where: { estabelecimentoId: id } }),
      prisma.mesa.deleteMany({ where: { estabelecimentoId: id } }),
      prisma.logAuditoria.deleteMany({ where: { estabelecimentoId: id } }),
      prisma.setor.deleteMany({ where: { estabelecimentoId: id } }),
